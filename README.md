...
![img](https://img-blog.csdnimg.cn/img_convert/9f072135aa57cbdc2efc3774117f6522.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/0613d4246191b848d976395aa038ca43.png)
...
- ![img](https://img-blog.csdnimg.cn/img_convert/fbd12cc2764ad6666e51e42cac7ab0e9.png)
- 通过flag包获取命令行参数
  - 如果用户没有传递参数`不会`报错
...
![img](https://img-blog.csdnimg.cn/img_convert/fd54bbf6b671155d3ae69add5144dbbc.png)
...
- 多个包之间代码执行顺序如下 ![img](https://img-blog.csdnimg.cn/img_convert/b17558afeb98b97b90f2c45e2faea7aa.png)
- init函数的作用
...
- 方式一: 通过数组创建切片`array[startIndex:endIndex]`
  ...
  ![img](https://img-blog.csdnimg.cn/img_convert/e0a19ca5adf790ed65f4404b2943d383.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/132272fa048fcaa2104fb71643f6d748.png)
...
- 值得注意点的是切片的本质就是一个指针指向数组, 所以指向切片的指针是一个二级指针 ![img](https://img-blog.csdnimg.cn/img_convert/bd52b364c6cd33366b6164261f6b93fd.png) ![img](https://img-blog.csdnimg.cn/img_convert/255aee583503be9a562b2619ff7b26a0.png)
...
- Object Oriented Programming-OOP ——面向对象编程 ![img](https://img-blog.csdnimg.cn/img_convert/cd74c646ab1aa816dd708ee1fdb8868e.png)
...
- 面向对象的核心就是对象,那怎么创建对象?
  - 现实生活中可以根据模板创建对象,编程语言也一样,也必须先有一个模板,在这个模板中说清楚将来创建出来的对象有哪些`属性`和`行为` ![img](https://img-blog.csdnimg.cn/img_convert/ee228cbe6617d9030119611e97625874.png)
...
- 拥有相同或者类似`属性`（状态特征）和`行为`（能干什么事）的对象都可以抽像成为一个类 ![img](https://img-blog.csdnimg.cn/img_convert/2ccc6a0a801fac3c43e3542588964497.png)
...
- 封装性
  - 封装性就是隐藏实现细节，仅对外公开接口 ![img](https://img-blog.csdnimg.cn/img_convert/4ec7304e2da4e1cd2b025dff35c8d012.png)
...
- 继承性
  ...
  - 所以go语言坚持了〃组合优于继承〃的原则, Go语言中所谓的继承其实是利用组合实现的(匿名结构体属性) ![img](https://img-blog.csdnimg.cn/img_convert/8b0f6a69e63519160001b2e6bffcdc91.png) ![img](https://img-blog.csdnimg.cn/img_convert/d018d96a829e67be3aa1c90d196f1a41.png)
- 普通继承(组合)
...
- 相关规则标准详见
  - [百度百科](https://baike.baidu.com/item/正则表达式/1700215?fr=aladdin)
...
- 常规问题:
  ...
  - 下载地址: [https://www.baidu.com/s?wd=sorry%2C%20unimplemented%3A%2064-bit%20mode%20not%20compiled%20in](https://www.baidu.com/s?wd=sorry%2C unimplemented%3A 64-bit mode not compiled in)
...
- 在计算机中, ***同一时刻, 只能有一条指令, 在一个CPU上执行, 后面的指令必须等到前面指令执行完才能执行\***, 就是串行 +![img](https://img-blog.csdnimg.cn/img_convert/39ad48a32bdea25b060d98d4e1d944be.png)

## 什么是并行?

- 并行就是同时执行, 就好比银行有3个窗口, 有3个人要办事, 只需要到空窗口即可立即办事.
- 在计算机中, ***同一时刻, 有多条指令, 在多个CPU上执行\***, 就是并行
- 从以上分析不难看出, 并行的速度优于串行 +![img](https://img-blog.csdnimg.cn/img_convert/e307bb971439803d5f2a6df338ddaed0.png)
...
- ![img](https://img-blog.csdnimg.cn/img_convert/82d7bafa3e92afc5078bca1da3976f34.png)
- ![img](https://img-blog.csdnimg.cn/img_convert/7858b93948b79c173d0fded8b40ba4d8.png)
...
- ![img](https://img-blog.csdnimg.cn/img_convert/741a250109c564caa3af9bce95c26565.png)
...
- ![img](https://img-blog.csdnimg.cn/img_convert/0d8dcd7011327debb4f28a65f3bc5bfc.png)
...
- 所谓的生产者消费者模型就是
  ...
  - 一般生产者消费者模型包含三个部分"生产者"、"缓冲区"、"消费者" ![img](https://img-blog.csdnimg.cn/img_convert/c6b9dc46029e893cc11f3a85b7f223f0.png)
...
- Channel的本质是一个队列
  - ![img](https://img-blog.csdnimg.cn/img_convert/0e4cca798a1aaa7a523221c4943da25e.png)
